...
Route::get('/zalopay/handle-return-url', action: [PaymentController::class, 'handleReturnUrl']);
...
Route::group([
  ...
  Route::post('me', action: [ApiAuthController::class, 'me']);
});
...
Route::group([
  ...
  Route::get(uri: '/user', action: [ApiAuthController::class, 'me'])->name('fe.get-user');
  ...
  Route::group(['prefix' => '/product'], function () {
    ...
    Route::get('/get-product-rent-id/{id}', [ProductRentHouseController::class, 'getDataProductRentById']);
