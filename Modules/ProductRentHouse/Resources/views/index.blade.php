...
@section('breadcrumbs')
    @php
        $breadcum = [
            [
                'name' => 'Quản lí tin cho thuê/mua bán',
                'url' => '/'
            ],
        ];
                    ...
                    <thead>
                        <tr>
                          <th data-field="index" data-align="center" data-width="5%" data-formatter="index_formatter">#</th>
                            ...
                            <th data-field="thumb" data-align="center" data-width="12%">Hình ảnh</th>
                            <th data-field="code" data-width="20%" data-formatter="name_formatter">Mã</th>
                            <th data-field="title" data-formatter="getModalCategory">Tiêu đề</th>
                            <th data-field="user_name" data-align="center" data-width="10%">Người đăng</th>
                            <th data-field="address" data-align="center" data-width="12%">Địa chỉ</th>
                            <th data-field="cost" data-align="center" data-width="12%">Giá</th>
                            <th data-field="createdAt2" data-align="center" data-width="12%">Ngày đăng</th>
                            <th data-field="type" data-align="center" data-width="12%">Loại</th>
                            <th data-field="status" data-align="center" data-width="12%" data-formatter="status_formatter">Trạng thái</th>
                            <th data-field="" data-align="center" data-width="12%">Chi tiết</th>
                        </tr>
                    </thead>
                </table>
